...
// router.post('/edit-user/:userId', verifyAdmin, async (req, res) => {
//     const userIdToEdit = req.params.userId;
    
//     // Check if the image or any other data is provided
//     const imageData = req.body.image;  // Assuming you're sending base64 image data or a link.
  
//     // Update user in Firestore
//     await db.collection('users').doc(userIdToEdit).update({ image: imageData });
